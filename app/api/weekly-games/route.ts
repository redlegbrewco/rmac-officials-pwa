...
export async function GET(request: NextRequest) {
  try {
    ...
    // Updated with real RMAC crew chiefs and realistic assignments
    ...
    const mockGames: GameAssignment[] = [
      ...
      },
      {
        ...
        referee: 'Jeff Bloszies',
        umpire: 'Rich Gray',
        headLinesman: 'Cecil Harrison',
        lineJudge: 'Charles Flinn',
        fieldJudge: 'Michael Gray',
        sideJudge: 'Chris Thompson',
      ...
      },
      {
        ...
        crewChief: 'Cecil Harrison',
        referee: 'Cecil Harrison',
        umpire: 'Jeff Bloszies',
        headLinesman: 'Michael Gray',
        lineJudge: 'Rich Gray',
        fieldJudge: 'Charles Flinn',
        sideJudge: 'Paul Jackson',
        backJudge: 'Kevin Brown',
        status: 'scheduled',
        scoutingReportSubmitted: false
      }
    ];
